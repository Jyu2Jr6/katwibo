<?php
  ...
  if (!empty($_REQUEST['month'])) {
    ...
    // 年単位の収支を計算する
    $syushi = syushiCalc($userId, $month);
...
<?php include($_SERVER['DOCUMENT_ROOT']  . '/katwibo/inc/header.php')?>
  ...
  <div class="container mt-4">
    <div class="row justify-content-center">
      <div class="col-12">
      <a class="btn btn-block btn-secondary mb-4" href="syushiYear.php?year=<?php print substr($month, 0, 4) ?>">戻る</a>
      <table class="table">
        <thead>
          <tr>
            <th>日付</th>
        ...
        <tbody>
          <?php foreach ((array)$shisyutsu as $key => $value): ?>
            ...
            <tr>
              <th><a href="syushiDay.php?date=<?php print $key ?>"><?php print $key ?></a></th>
