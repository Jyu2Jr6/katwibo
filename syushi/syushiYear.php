<?php
  ...
  if (!empty($_REQUEST['year'])) {
    ...
    // 年単位の収支を計算する
    $syushi = syushiCalc($userId, $year, 4);
...
<?php include($_SERVER['DOCUMENT_ROOT']  . '/katwibo/inc/header.php')?>
  ...
  <div class="container mt-4">
    <div class="row justify-content-center">
      <div class="col-12">
      <a class="btn btn-block btn-secondary mb-4" href="syushi.php">戻る</a>
      <table class="table">
        <thead>
          <tr>
            <th>日付</th>
        ...
        <tbody>
          <?php foreach ((array)$shisyutsu as $key => $value): ?>
            ...
            <tr>
              <th><a href="syushiMonth.php?month=<?php print $key ?>"><?php print $key ?></a></th>
